...
df.sub = df %>% filter(Count_pc > 0.80)
pred = predict(lm(Diff ~ Count_pc, df.sub), data.frame(Count_pc = seq(0.9, 1, 0.01)))
pred.df = data.frame(Count_pc = seq(0.9, 1, 0.01), Diff = pred)
